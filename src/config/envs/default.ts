  ...
  return {
    ...
    healthcheck: {
      ...
      storageTimeoutMs: process.env.HEALTH_STORAGE_TIMEOUT_MS
        ...
        : DEFAULT_TIMEOUT_MS,
      dbStatsKey: process.env.HEALTH_DB_STATS_KEY?.trim() || undefined
    },
    session: {
    ...
    database: {
      ...
      consumerPoolSize: parseInt(process.env.DB_POOL_SIZE_CONSUMER || process.env.DB_POOL_SIZE || '10', 10),
      publisherPoolSize: parseInt(process.env.DB_POOL_SIZE_PUBLISHER || process.env.DB_POOL_SIZE || '10', 10),
