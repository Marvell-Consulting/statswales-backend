...
export class InitialSchema1728317838261 implements MigrationInterface {
    name = 'InitialSchema1728317838261';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE INDEX "IX_user_provider" ON "users" ("provider")
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            CREATE TABLE "categories" (
                ...
                CONSTRAINT "PK_bcd0361927be4baf8a1f401590e" PRIMARY KEY ("category")
            )
        `);
        await queryRunner.query(`
            CREATE TABLE "category_keys" (
                ...
                "category" text NOT NULL,
                CONSTRAINT "PK_fc70ab7334757e89820c5db7f5f" PRIMARY KEY ("category_key")
            )
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ALTER TABLE "dataset"
            ADD CONSTRAINT "FK_dataset_created_by" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ALTER TABLE "revision"
            ADD CONSTRAINT "FK_revision_created_by" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "revision"
            ADD CONSTRAINT "FK_revision_approved_by" FOREIGN KEY ("approved_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "category_keys"
            ADD CONSTRAINT "FK_e189d3ff5a06236d4d1c1149786" FOREIGN KEY ("category") REFERENCES "categories"("category") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "reference_data"
            ADD CONSTRAINT "FK_dd4ff535904e339641b0b0d52c2" FOREIGN KEY ("category_key") REFERENCES "category_keys"("category_key") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_68028565126809c1e925e6f9334" FOREIGN KEY ("category") REFERENCES "categories"("category") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_ec0b41bafd5605fff51fc0c8e47" FOREIGN KEY ("category_key") REFERENCES "category_keys"("category_key") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "category_keys" DROP CONSTRAINT "FK_e189d3ff5a06236d4d1c1149786"
        `);
        await queryRunner.query(`
