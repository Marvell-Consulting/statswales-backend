...
export class InitialSchema1732641435620 implements MigrationInterface {
    name = 'InitialSchema1732641435620'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."fact_Table_filetype_enum" AS ENUM('csv', 'parquet', 'json', 'xlsx', 'unknown')
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."lookup_table_filetype_enum" AS ENUM('csv', 'parquet', 'json', 'xlsx', 'unknown')
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_fact_table_info_fact_table_id_id" FOREIGN KEY ("fact_table_id") REFERENCES "fact_Table"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT "FK_lookup_dimension_id" FOREIGN KEY ("dimension_id") REFERENCES "dimension"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
            ALTER TABLE "lookup_table"
            ADD CONSTRAINT "FK_lookup_measure_id" FOREIGN KEY ("measure_id") REFERENCES "measure"("id") ON DELETE CASCADE ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "lookup_table" DROP CONSTRAINT "FK_lookup_measure_id"
        `);
        await queryRunner.query(`
            ALTER TABLE "lookup_table" DROP CONSTRAINT "FK_lookup_dimension_id"
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "fact_table_info" DROP CONSTRAINT "FK_fact_table_info_fact_table_id_id"
        `);
        await queryRunner.query(`
