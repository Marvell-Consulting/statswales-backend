...
// GET /build/type/base
// Returns the most recent base cube build log entries.
// query params:
// - size: number of entries to return (default 30)
// - page: page offset, allows paging the build log
...
// Returns the most recent validation cube build log entries.
// query params:
// - size: number of entries to return (default 30)
// - page: page offset, allows paging the build log
...
// GET /build/type/full
// Returns the most recent full cube build log entries.
// query params:
// - size: number of entries to return (default 30)
// - page: page offset, allows paging the build log
...
// Returns the most recent draft cube build log entries.
// query params:
// - size: number of entries to return (default 30)
// - page: page offset, allows paging the build log
...
// GET /build/type/all
// Returns the most recent build log entries for all cube types.
// query params:
// - size: number of entries to return (default 30)
// - page: page offset, allows paging the build log
